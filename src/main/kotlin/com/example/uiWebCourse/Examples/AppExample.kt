package com.example.uiWebCourse.Examples


import com.example.uiWebCourse.App
import io.kvision.*
...
class Apps : Application() {
    ...
    private val store = createReduxStore(::pokedexReducer,
        Pokedex(false, null, listOf(), listOf(), null, 0, 1)
    )
